...
#if RELEASE
#if BETA
#define VERSION crypt_str("gamesense | ")
#else
#define VERSION crypt_str("gamesense | ")
#endif
#else
...
void misc::ChatSpamer()
{
	...
	{ 
		crypt_str("gamesense - stay with us or lose the game."),
		crypt_str("Get good. Get gamesense."),
		crypt_str("gamesense - just the best."),
		crypt_str("Go to another level with gamesense."),
	};
