...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.misc.clantag_spammer_pastesense, false, crypt_str("Misc.clantag_spammer_pastesense"));
	setup_item(&g_cfg.misc.clantag_spammer_unlucky, false, crypt_str("Misc.clantag_spammer_unlucky"));
