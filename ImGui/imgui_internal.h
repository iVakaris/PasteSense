...
namespace ui
{
	...
	bool BeginNemesis(const char* name, bool* p_open, ImGuiWindowFlags flags);

	void EndNemesis();

	bool BeginChildExNemesis(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);

	bool BeginChildNemesis(const char* str_id, const ImVec2& size_arg, bool border, ImGuiWindowFlags extra_flags);

	void EndChildNemesis();

	void EndPopupNemesis();

	void EndComboNemesis();

    bool SliderBehaviorNemesis(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format, float power, ImGuiSliderFlags flags, ImRect* out_grab_bb);

	bool ButtonExDef(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags);

	bool ButtonDef(const char* label, const ImVec2& size_arg);
